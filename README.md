...
Before running, generate pseudo-bulk ATAC bigWig files by following [scHiCAR downstream analysis codes](https://github.com/yueyuanxu/scHiCAR/edit/dev/5_downstream_analysis/README.md#:~:text=100-,101,-102)
```bash
