...
Before running, generate pseudo-bulk ATAC bigWig files by following [scHiCAR downstream analysis codes](https://github.com/yueyuanxu/scHiCAR/blob/dev/5_downstream_analysis?plain=1#L101)
```bash
